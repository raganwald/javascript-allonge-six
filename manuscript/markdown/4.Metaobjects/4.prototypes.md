...
As mentioned above, official support for changing the prototype of an object will be coming in ECMAScript 2015, but it is not here now. Some shims and workarounds exist, but may not be available in all environments. There are also performance implications to consider, although we do not focus on that in this book.
