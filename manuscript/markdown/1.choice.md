...
In JavaScript, there is a notion of "truthiness." Every value in JavaScript is "truthy" except `false`, `0` (zero), `null`, and `undefined`. The opposite of "truthy" is "falsy," and the aforementioned `false`, `0`, `null`, and `undefined` are considered "falsy."
