...
Let's take a look at a very simple example, [naughts and crosses]. To save space, we'll ignore rotations and reflections, and we'll model the first player's moves as a stream

[naughts and crosses]: https://en.wikipedia.org/wiki/naughts-and-crosses
...
If it 8was* possible, how would it work? 
