...
This coupling exists for all metaobject patterns that include open recursion, such as mixins, delegation, and delegation through prototypes. In particular, when chains of naive prototypes form [class hierarchies][ch], this coupling leads to the [fragile base class problem][fbc].
